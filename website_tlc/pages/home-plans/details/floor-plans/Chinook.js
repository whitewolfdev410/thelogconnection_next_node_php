...
const FloorPlanPage = () => {
    ...
    return (
        <>
            <Head>
                <title>{`Chinook`} Log Home Design by The Log Connection</title>
                <meta property="og:image" content={`${IMG_BANNER_FILE_ROOT}Chinook.jpg`} />
                <meta property="og:type" content="article" />
                <meta property="og:url" content={`${HOME_PLAN_DETAILS_PATH.FLOOR_PLAN}/Chinook?scroll=false`} />
                <meta property="og:title" content={`Chinook Log Home Design by The Log Connection`} />
                <meta property="og:description" content={`Floor plans for Chinook`} />
            </Head>
            <section>
                <HomePlanBanner
