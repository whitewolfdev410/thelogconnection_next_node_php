...
const FloorPlanPage = () => {
    ...
    return (
        <>
            <Head>
                <title>{`Waterford`} Log Home Design by The Log Connection</title>
                <meta property="og:image" content={`${IMG_BANNER_FILE_ROOT}Waterford.jpg`} />
                <meta property="og:type" content="article" />
                <meta property="og:url" content={`${HOME_PLAN_DETAILS_PATH.FLOOR_PLAN}/Waterford?scroll=false`} />
                <meta property="og:title" content={`Waterford Log Home Design by The Log Connection`} />
                <meta property="og:description" content={`Floor plans for Waterford`} />
            </Head>
            <section>
                <HomePlanBanner
