...
const FloorPlanPage = () => {
    ...
    return (
        <>
            <Head>
                <title>{`Bay_View`} Log Home Design by The Log Connection</title>
                <meta property="og:image" content={`${IMG_BANNER_FILE_ROOT}Bay_View.jpg`} />
                <meta property="og:type" content="article" />
                <meta property="og:url" content={`${HOME_PLAN_DETAILS_PATH.FLOOR_PLAN}/Bay_View?scroll=false`} />
                <meta property="og:title" content={`Bay_View Log Home Design by The Log Connection`} />
                <meta property="og:description" content={`Floor plans for Bay_View`} />
            </Head>
            <section>
                <HomePlanBanner
