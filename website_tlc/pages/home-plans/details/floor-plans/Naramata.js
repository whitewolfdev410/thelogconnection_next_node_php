...
const FloorPlanPage = () => {
    ...
    return (
        <>
            <Head>
                <title>{`Naramata`} Log Home Design by The Log Connection</title>
                <meta property="og:image" content={`${IMG_BANNER_FILE_ROOT}Naramata.jpg`} />
                <meta property="og:type" content="article" />
                <meta property="og:url" content={`${HOME_PLAN_DETAILS_PATH.FLOOR_PLAN}/Naramata?scroll=false`} />
                <meta property="og:title" content={`Naramata Log Home Design by The Log Connection`} />
                <meta property="og:description" content={`Floor plans for Naramata`} />
            </Head>
            <section>
                <HomePlanBanner
