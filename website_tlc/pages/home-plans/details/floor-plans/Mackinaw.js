...
const FloorPlanPage = () => {
    ...
    return (
        <>
            <Head>
                <title>{`Mackinaw`} Log Home Design by The Log Connection</title>
                <meta property="og:image" content={`${IMG_BANNER_FILE_ROOT}Mackinaw.jpg`} />
                <meta property="og:type" content="article" />
                <meta property="og:url" content={`${HOME_PLAN_DETAILS_PATH.FLOOR_PLAN}/Mackinaw?scroll=false`} />
                <meta property="og:title" content={`Mackinaw Log Home Design by The Log Connection`} />
                <meta property="og:description" content={`Floor plans for Mackinaw`} />
            </Head>
            <section>
                <HomePlanBanner
