...
const FloorPlanPage = () => {
    ...
    return (
        <>
            <Head>
                <title>{`Eagles_Nest`} Log Home Design by The Log Connection</title>
                <meta property="og:image" content={`${IMG_BANNER_FILE_ROOT}Eagles_Nest.jpg`} />
                <meta property="og:type" content="article" />
                <meta property="og:url" content={`${HOME_PLAN_DETAILS_PATH.FLOOR_PLAN}/Eagles_Nest?scroll=false`} />
                <meta property="og:title" content={`Eagles_Nest Log Home Design by The Log Connection`} />
                <meta property="og:description" content={`Floor plans for Eagles_Nest`} />
            </Head>
            <section>
                <HomePlanBanner
