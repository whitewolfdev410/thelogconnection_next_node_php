...
const FloorPlanPage = () => {
    ...
    return (
        <>
            <Head>
                <title>{`Victoria`} Log Home Design by The Log Connection</title>
                <meta property="og:image" content={`${IMG_BANNER_FILE_ROOT}Victoria.jpg`} />
                <meta property="og:type" content="article" />
                <meta property="og:url" content={`${HOME_PLAN_DETAILS_PATH.FLOOR_PLAN}/Victoria?scroll=false`} />
                <meta property="og:title" content={`Victoria Log Home Design by The Log Connection`} />
                <meta property="og:description" content={`Floor plans for Victoria`} />
            </Head>
            <section>
                <HomePlanBanner
