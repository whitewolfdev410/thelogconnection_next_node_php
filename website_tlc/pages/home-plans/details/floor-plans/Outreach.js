...
const FloorPlanPage = () => {
    ...
    return (
        <>
            <Head>
                <title>{`Outreach`} Log Home Design by The Log Connection</title>
                <meta property="og:image" content={`${IMG_BANNER_FILE_ROOT}Outreach.jpg`} />
                <meta property="og:type" content="article" />
                <meta property="og:url" content={`${HOME_PLAN_DETAILS_PATH.FLOOR_PLAN}/Outreach?scroll=false`} />
                <meta property="og:title" content={`Outreach Log Home Design by The Log Connection`} />
                <meta property="og:description" content={`Floor plans for Outreach`} />
            </Head>
            <section>
                <HomePlanBanner
