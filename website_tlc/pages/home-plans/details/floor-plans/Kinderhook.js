...
const FloorPlanPage = () => {
    ...
    return (
        <>
            <Head>
                <title>{`Kinderhook`} Log Home Design by The Log Connection</title>
                <meta property="og:image" content={`${IMG_BANNER_FILE_ROOT}Kinderhook.jpg`} />
                <meta property="og:type" content="article" />
                <meta property="og:url" content={`${HOME_PLAN_DETAILS_PATH.FLOOR_PLAN}/Kinderhook?scroll=false`} />
                <meta property="og:title" content={`Kinderhook Log Home Design by The Log Connection`} />
                <meta property="og:description" content={`Floor plans for Kinderhook`} />
            </Head>
            <section>
                <HomePlanBanner
