...
const FloorPlanPage = () => {
    ...
    return (
        <>
            <Head>
                <title>{`Minocqua`} Log Home Design by The Log Connection</title>
                <meta property="og:image" content={`${IMG_BANNER_FILE_ROOT}Minocqua.jpg`} />
                <meta property="og:type" content="article" />
                <meta property="og:url" content={`${HOME_PLAN_DETAILS_PATH.FLOOR_PLAN}/Minocqua?scroll=false`} />
                <meta property="og:title" content={`Minocqua Log Home Design by The Log Connection`} />
                <meta property="og:description" content={`Floor plans for Minocqua`} />
            </Head>
            <section>
                <HomePlanBanner
