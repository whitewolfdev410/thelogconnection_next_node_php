...
const FloorPlanPage = () => {
    ...
    return (
        <>
            <Head>
                <title>{`Pinecrest`} Log Home Design by The Log Connection</title>
                <meta property="og:image" content={`${IMG_BANNER_FILE_ROOT}Pinecrest.jpg`} />
                <meta property="og:type" content="article" />
                <meta property="og:url" content={`${HOME_PLAN_DETAILS_PATH.FLOOR_PLAN}/Pinecrest?scroll=false`} />
                <meta property="og:title" content={`Pinecrest Log Home Design by The Log Connection`} />
                <meta property="og:description" content={`Floor plans for Pinecrest`} />
            </Head>
            <section>
                <HomePlanBanner
