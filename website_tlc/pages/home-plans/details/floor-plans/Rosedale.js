...
const FloorPlanPage = () => {
    ...
    return (
        <>
            <Head>
                <title>{`Rosedale`} Log Home Design by The Log Connection</title>
                <meta property="og:image" content={`${IMG_BANNER_FILE_ROOT}Rosedale.jpg`} />
                <meta property="og:type" content="article" />
                <meta property="og:url" content={`${HOME_PLAN_DETAILS_PATH.FLOOR_PLAN}/Rosedale?scroll=false`} />
                <meta property="og:title" content={`Rosedale Log Home Design by The Log Connection`} />
                <meta property="og:description" content={`Floor plans for Rosedale`} />
            </Head>
            <section>
                <HomePlanBanner
