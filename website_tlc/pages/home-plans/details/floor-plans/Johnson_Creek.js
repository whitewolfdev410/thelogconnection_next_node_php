...
const FloorPlanPage = () => {
    ...
    return (
        <>
            <Head>
                <title>{`Johnson_Creek`} Log Home Design by The Log Connection</title>
                <meta property="og:image" content={`${IMG_BANNER_FILE_ROOT}Johnson_Creek.jpg`} />
                <meta property="og:type" content="article" />
                <meta property="og:url" content={`${HOME_PLAN_DETAILS_PATH.FLOOR_PLAN}/Johnson_Creek?scroll=false`} />
                <meta property="og:title" content={`Johnson_Creek Log Home Design by The Log Connection`} />
                <meta property="og:description" content={`Floor plans for Johnson_Creek`} />
            </Head>
            <section>
                <HomePlanBanner
