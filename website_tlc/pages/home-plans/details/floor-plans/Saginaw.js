...
const FloorPlanPage = () => {
    ...
    return (
        <>
            <Head>
                <title>{`Saginaw`} Log Home Design by The Log Connection</title>
                <meta property="og:image" content={`${IMG_BANNER_FILE_ROOT}Saginaw.jpg`} />
                <meta property="og:type" content="article" />
                <meta property="og:url" content={`${HOME_PLAN_DETAILS_PATH.FLOOR_PLAN}/Saginaw?scroll=false`} />
                <meta property="og:title" content={`Saginaw Log Home Design by The Log Connection`} />
                <meta property="og:description" content={`Floor plans for Saginaw`} />
            </Head>
            <section>
                <HomePlanBanner
