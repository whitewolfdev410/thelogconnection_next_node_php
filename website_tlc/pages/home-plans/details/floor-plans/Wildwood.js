...
const FloorPlanPage = () => {
    ...
    return (
        <>
            <Head>
                <title>{`Wildwood`} Log Home Design by The Log Connection</title>
                <meta property="og:image" content={`${IMG_BANNER_FILE_ROOT}Wildwood.jpg`} />
                <meta property="og:type" content="article" />
                <meta property="og:url" content={`${HOME_PLAN_DETAILS_PATH.FLOOR_PLAN}/Wildwood?scroll=false`} />
                <meta property="og:title" content={`Wildwood Log Home Design by The Log Connection`} />
                <meta property="og:description" content={`Floor plans for Wildwood`} />
            </Head>
            <section>
                <HomePlanBanner
