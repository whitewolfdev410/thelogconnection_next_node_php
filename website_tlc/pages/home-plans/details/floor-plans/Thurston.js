...
const FloorPlanPage = () => {
    ...
    return (
        <>
            <Head>
                <title>{`Thurston`} Log Home Design by The Log Connection</title>
                <meta property="og:image" content={`${IMG_BANNER_FILE_ROOT}Thurston.jpg`} />
                <meta property="og:type" content="article" />
                <meta property="og:url" content={`${HOME_PLAN_DETAILS_PATH.FLOOR_PLAN}/Thurston?scroll=false`} />
                <meta property="og:title" content={`Thurston Log Home Design by The Log Connection`} />
                <meta property="og:description" content={`Floor plans for Thurston`} />
            </Head>
            <section>
                <HomePlanBanner
