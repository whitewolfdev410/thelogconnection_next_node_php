...
const FloorPlanPage = () => {
    ...
    return (
        <>
            <Head>
                <title>{`Cherryville`} Log Home Design by The Log Connection</title>
                <meta property="og:image" content={`${IMG_BANNER_FILE_ROOT}Cherryville.jpg`} />
                <meta property="og:type" content="article" />
                <meta property="og:url" content={`${HOME_PLAN_DETAILS_PATH.FLOOR_PLAN}/Cherryville?scroll=false`} />
                <meta property="og:title" content={`Cherryville Log Home Design by The Log Connection`} />
                <meta property="og:description" content={`Floor plans for Cherryville`} />
            </Head>
            <section>
                <HomePlanBanner
