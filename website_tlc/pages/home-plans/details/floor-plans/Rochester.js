...
const FloorPlanPage = () => {
    ...
    return (
        <>
            <Head>
                <title>{`Rochester`} Log Home Design by The Log Connection</title>
                <meta property="og:image" content={`${IMG_BANNER_FILE_ROOT}Rochester.jpg`} />
                <meta property="og:type" content="article" />
                <meta property="og:url" content={`${HOME_PLAN_DETAILS_PATH.FLOOR_PLAN}/Rochester?scroll=false`} />
                <meta property="og:title" content={`Rochester Log Home Design by The Log Connection`} />
                <meta property="og:description" content={`Floor plans for Rochester`} />
            </Head>
            <section>
                <HomePlanBanner
