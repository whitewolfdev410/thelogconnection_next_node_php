...
const FloorPlanPage = () => {
    ...
    return (
        <>
            <Head>
                <title>{`Ambrosio`} Log Home Design by The Log Connection</title>
                <meta property="og:image" content={`${IMG_BANNER_FILE_ROOT}Ambrosio.jpg`} />
                <meta property="og:type" content="article" />
                <meta property="og:url" content={`${HOME_PLAN_DETAILS_PATH.FLOOR_PLAN}/Ambrosio?scroll=false`} />
                <meta property="og:title" content={`Ambrosio Log Home Design by The Log Connection`} />
                <meta property="og:description" content={`Floor plans for Ambrosio`} />
            </Head>
            <section>
                <HomePlanBanner
