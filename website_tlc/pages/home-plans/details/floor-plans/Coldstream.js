...
const FloorPlanPage = () => {
    ...
    return (
        <>
            <Head>
                <title>{`Coldstream`} Log Home Design by The Log Connection</title>
                <meta property="og:image" content={`${IMG_BANNER_FILE_ROOT}Coldstream.jpg`} />
                <meta property="og:type" content="article" />
                <meta property="og:url" content={`${HOME_PLAN_DETAILS_PATH.FLOOR_PLAN}/Coldstream?scroll=false`} />
                <meta property="og:title" content={`Coldstream Log Home Design by The Log Connection`} />
                <meta property="og:description" content={`Floor plans for Coldstream`} />
            </Head>
            <section>
                <HomePlanBanner
