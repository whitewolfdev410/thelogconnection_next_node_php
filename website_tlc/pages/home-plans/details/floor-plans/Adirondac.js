...
const FloorPlanPage = () => {
    ...
    return (
        <>
            <Head>
                <title>{`Adirondac`} Log Home Design by The Log Connection</title>
                <meta property="og:image" content={`${IMG_BANNER_FILE_ROOT}Adirondac.jpg`} />
                <meta property="og:type" content="article" />
                <meta property="og:url" content={`${HOME_PLAN_DETAILS_PATH.FLOOR_PLAN}/Adirondac?scroll=false`} />
                <meta property="og:title" content={`Adirondac Log Home Design by The Log Connection`} />
                <meta property="og:description" content={`Floor plans for Adirondac`} />
            </Head>
            <section>
                <HomePlanBanner
