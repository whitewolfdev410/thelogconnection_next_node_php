...
const FloorPlanPage = () => {
    ...
    return (
        <>
            <Head>
                <title>{`Wenatchee`} Log Home Design by The Log Connection</title>
                <meta property="og:image" content={`${IMG_BANNER_FILE_ROOT}Wenatchee.jpg`} />
                <meta property="og:type" content="article" />
                <meta property="og:url" content={`${HOME_PLAN_DETAILS_PATH.FLOOR_PLAN}/Wenatchee?scroll=false`} />
                <meta property="og:title" content={`Wenatchee Log Home Design by The Log Connection`} />
                <meta property="og:description" content={`Floor plans for Wenatchee`} />
            </Head>
            <section>
                <HomePlanBanner
