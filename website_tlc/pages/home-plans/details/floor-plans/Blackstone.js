...
const FloorPlanPage = () => {
    ...
    return (
        <>
            <Head>
                <title>{`Blackstone`} Log Home Design by The Log Connection</title>
                <meta property="og:image" content={`${IMG_BANNER_FILE_ROOT}Blackstone.jpg`} />
                <meta property="og:type" content="article" />
                <meta property="og:url" content={`${HOME_PLAN_DETAILS_PATH.FLOOR_PLAN}/Blackstone?scroll=false`} />
                <meta property="og:title" content={`Blackstone Log Home Design by The Log Connection`} />
                <meta property="og:description" content={`Floor plans for Blackstone`} />
            </Head>
            <section>
                <HomePlanBanner
