...
const FloorPlanPage = () => {
    ...
    return (
        <>
            <Head>
                <title>{`Oyama`} Log Home Design by The Log Connection</title>
                <meta property="og:image" content={`${IMG_BANNER_FILE_ROOT}Oyama.jpg`} />
                <meta property="og:type" content="article" />
                <meta property="og:url" content={`${HOME_PLAN_DETAILS_PATH.FLOOR_PLAN}/Oyama?scroll=false`} />
                <meta property="og:title" content={`Oyama Log Home Design by The Log Connection`} />
                <meta property="og:description" content={`Floor plans for Oyama`} />
            </Head>
            <section>
                <HomePlanBanner
