...
const FloorPlanPage = () => {
    ...
    return (
        <>
            <Head>
                <title>{`Englewood`} Log Home Design by The Log Connection</title>
                <meta property="og:image" content={`${IMG_BANNER_FILE_ROOT}Englewood.jpg`} />
                <meta property="og:type" content="article" />
                <meta property="og:url" content={`${HOME_PLAN_DETAILS_PATH.FLOOR_PLAN}/Englewood?scroll=false`} />
                <meta property="og:title" content={`Englewood Log Home Design by The Log Connection`} />
                <meta property="og:description" content={`Floor plans for Englewood`} />
            </Head>
            <section>
                <HomePlanBanner
