...
const FloorPlanPage = () => {
    ...
    return (
        <>
            <Head>
                <title>{`Madison`} Log Home Design by The Log Connection</title>
                <meta property="og:image" content={`${IMG_BANNER_FILE_ROOT}Madison.jpg`} />
                <meta property="og:type" content="article" />
                <meta property="og:url" content={`${HOME_PLAN_DETAILS_PATH.FLOOR_PLAN}/Madison?scroll=false`} />
                <meta property="og:title" content={`Madison Log Home Design by The Log Connection`} />
                <meta property="og:description" content={`Floor plans for Madison`} />
            </Head>
            <section>
                <HomePlanBanner
