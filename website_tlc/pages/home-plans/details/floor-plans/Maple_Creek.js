...
const FloorPlanPage = () => {
    ...
    return (
        <>
            <Head>
                <title>{`Maple_Creek`} Log Home Design by The Log Connection</title>
                <meta property="og:image" content={`${IMG_BANNER_FILE_ROOT}Maple_Creek.jpg`} />
                <meta property="og:type" content="article" />
                <meta property="og:url" content={`${HOME_PLAN_DETAILS_PATH.FLOOR_PLAN}/Maple_Creek?scroll=false`} />
                <meta property="og:title" content={`Maple_Creek Log Home Design by The Log Connection`} />
                <meta property="og:description" content={`Floor plans for Maple_Creek`} />
            </Head>
            <section>
                <HomePlanBanner
