...
const FloorPlanPage = () => {
    ...
    return (
        <>
            <Head>
                <title>{`Skeena`} Log Home Design by The Log Connection</title>
                <meta property="og:image" content={`${IMG_BANNER_FILE_ROOT}Skeena.jpg`} />
                <meta property="og:type" content="article" />
                <meta property="og:url" content={`${HOME_PLAN_DETAILS_PATH.FLOOR_PLAN}/Skeena?scroll=false`} />
                <meta property="og:title" content={`Skeena Log Home Design by The Log Connection`} />
                <meta property="og:description" content={`Floor plans for Skeena`} />
            </Head>
            <section>
                <HomePlanBanner
