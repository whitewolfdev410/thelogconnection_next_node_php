...
const FloorPlanPage = () => {
    ...
    return (
        <>
            <Head>
                <title>{`Algonquin`} Log Home Design by The Log Connection</title>
                <meta property="og:image" content={`${IMG_BANNER_FILE_ROOT}Algonquin.jpg`} />
                <meta property="og:type" content="article" />
                <meta property="og:url" content={`${HOME_PLAN_DETAILS_PATH.FLOOR_PLAN}/Algonquin?scroll=false`} />
                <meta property="og:title" content={`Algonquin Log Home Design by The Log Connection`} />
                <meta property="og:description" content={`Floor plans for Algonquin`} />
            </Head>
            <section>
                <HomePlanBanner
