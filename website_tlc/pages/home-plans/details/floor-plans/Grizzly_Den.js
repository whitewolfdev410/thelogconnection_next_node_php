...
const FloorPlanPage = () => {
    ...
    return (
        <>
            <Head>
                <title>{`Grizzly_Den`} Log Home Design by The Log Connection</title>
                <meta property="og:image" content={`${IMG_BANNER_FILE_ROOT}Grizzly_Den.jpg`} />
                <meta property="og:type" content="article" />
                <meta property="og:url" content={`${HOME_PLAN_DETAILS_PATH.FLOOR_PLAN}/Grizzly_Den?scroll=false`} />
                <meta property="og:title" content={`Grizzly_Den Log Home Design by The Log Connection`} />
                <meta property="og:description" content={`Floor plans for Grizzly_Den`} />
            </Head>
            <section>
                <HomePlanBanner
