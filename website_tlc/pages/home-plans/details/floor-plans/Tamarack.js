...
const FloorPlanPage = () => {
    ...
    return (
        <>
            <Head>
                <title>{`Tamarack`} Log Home Design by The Log Connection</title>
                <meta property="og:image" content={`${IMG_BANNER_FILE_ROOT}Tamarack.jpg`} />
                <meta property="og:type" content="article" />
                <meta property="og:url" content={`${HOME_PLAN_DETAILS_PATH.FLOOR_PLAN}/Tamarack?scroll=false`} />
                <meta property="og:title" content={`Tamarack Log Home Design by The Log Connection`} />
                <meta property="og:description" content={`Floor plans for Tamarack`} />
            </Head>
            <section>
                <HomePlanBanner
