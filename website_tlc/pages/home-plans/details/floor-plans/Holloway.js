...
const FloorPlanPage = () => {
    ...
    return (
        <>
            <Head>
                <title>{`Holloway`} Log Home Design by The Log Connection</title>
                <meta property="og:image" content={`${IMG_BANNER_FILE_ROOT}Holloway.jpg`} />
                <meta property="og:type" content="article" />
                <meta property="og:url" content={`${HOME_PLAN_DETAILS_PATH.FLOOR_PLAN}/Holloway?scroll=false`} />
                <meta property="og:title" content={`Holloway Log Home Design by The Log Connection`} />
                <meta property="og:description" content={`Floor plans for Holloway`} />
            </Head>
            <section>
                <HomePlanBanner
