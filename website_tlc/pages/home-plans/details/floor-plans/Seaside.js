...
const FloorPlanPage = () => {
    ...
    return (
        <>
            <Head>
                <title>{`Seaside`} Log Home Design by The Log Connection</title>
                <meta property="og:image" content={`${IMG_BANNER_FILE_ROOT}Seaside.jpg`} />
                <meta property="og:type" content="article" />
                <meta property="og:url" content={`${HOME_PLAN_DETAILS_PATH.FLOOR_PLAN}/Seaside?scroll=false`} />
                <meta property="og:title" content={`Seaside Log Home Design by The Log Connection`} />
                <meta property="og:description" content={`Floor plans for Seaside`} />
            </Head>
            <section>
                <HomePlanBanner
