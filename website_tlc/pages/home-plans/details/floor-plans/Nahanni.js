...
const FloorPlanPage = () => {
    ...
    return (
        <>
            <Head>
                <title>{`Nahanni`} Log Home Design by The Log Connection</title>
                <meta property="og:image" content={`${IMG_BANNER_FILE_ROOT}Nahanni.jpg`} />
                <meta property="og:type" content="article" />
                <meta property="og:url" content={`${HOME_PLAN_DETAILS_PATH.FLOOR_PLAN}/Nahanni?scroll=false`} />
                <meta property="og:title" content={`Nahanni Log Home Design by The Log Connection`} />
                <meta property="og:description" content={`Floor plans for Nahanni`} />
            </Head>
            <section>
                <HomePlanBanner
