...
const FloorPlanPage = () => {
    ...
    return (
        <>
            <Head>
                <title>{`Fairmont`} Log Home Design by The Log Connection</title>
                <meta property="og:image" content={`${IMG_BANNER_FILE_ROOT}Fairmont.jpg`} />
                <meta property="og:type" content="article" />
                <meta property="og:url" content={`${HOME_PLAN_DETAILS_PATH.FLOOR_PLAN}/Fairmont?scroll=false`} />
                <meta property="og:title" content={`Fairmont Log Home Design by The Log Connection`} />
                <meta property="og:description" content={`Floor plans for Fairmont`} />
            </Head>
            <section>
                <HomePlanBanner
