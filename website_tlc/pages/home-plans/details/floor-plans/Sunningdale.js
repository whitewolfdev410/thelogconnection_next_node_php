...
const FloorPlanPage = () => {
    ...
    return (
        <>
            <Head>
                <title>{`Sunningdale`} Log Home Design by The Log Connection</title>
                <meta property="og:image" content={`${IMG_BANNER_FILE_ROOT}Sunningdale.jpg`} />
                <meta property="og:type" content="article" />
                <meta property="og:url" content={`${HOME_PLAN_DETAILS_PATH.FLOOR_PLAN}/Sunningdale?scroll=false`} />
                <meta property="og:title" content={`Sunningdale Log Home Design by The Log Connection`} />
                <meta property="og:description" content={`Floor plans for Sunningdale`} />
            </Head>
            <section>
                <HomePlanBanner
