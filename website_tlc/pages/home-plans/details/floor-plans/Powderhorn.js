...
const FloorPlanPage = () => {
    ...
    return (
        <>
            <Head>
                <title>{`Powderhorn`} Log Home Design by The Log Connection</title>
                <meta property="og:image" content={`${IMG_BANNER_FILE_ROOT}Powderhorn.jpg`} />
                <meta property="og:type" content="article" />
                <meta property="og:url" content={`${HOME_PLAN_DETAILS_PATH.FLOOR_PLAN}/Powderhorn?scroll=false`} />
                <meta property="og:title" content={`Powderhorn Log Home Design by The Log Connection`} />
                <meta property="og:description" content={`Floor plans for Powderhorn`} />
            </Head>
            <section>
                <HomePlanBanner
