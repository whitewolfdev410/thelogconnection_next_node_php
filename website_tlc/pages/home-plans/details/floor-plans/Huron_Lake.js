...
const FloorPlanPage = () => {
    ...
    return (
        <>
            <Head>
                <title>{`Huron_Lake`} Log Home Design by The Log Connection</title>
                <meta property="og:image" content={`${IMG_BANNER_FILE_ROOT}Huron_Lake.jpg`} />
                <meta property="og:type" content="article" />
                <meta property="og:url" content={`${HOME_PLAN_DETAILS_PATH.FLOOR_PLAN}/Huron_Lake?scroll=false`} />
                <meta property="og:title" content={`Huron_Lake Log Home Design by The Log Connection`} />
                <meta property="og:description" content={`Floor plans for Huron_Lake`} />
            </Head>
            <section>
                <HomePlanBanner
