...
const FloorPlanPage = () => {
    ...
    return (
        <>
            <Head>
                <title>{`Saratoga`} Log Home Design by The Log Connection</title>
                <meta property="og:image" content={`${IMG_BANNER_FILE_ROOT}Saratoga.jpg`} />
                <meta property="og:type" content="article" />
                <meta property="og:url" content={`${HOME_PLAN_DETAILS_PATH.FLOOR_PLAN}/Saratoga?scroll=false`} />
                <meta property="og:title" content={`Saratoga Log Home Design by The Log Connection`} />
                <meta property="og:description" content={`Floor plans for Saratoga`} />
            </Head>
            <section>
                <HomePlanBanner
