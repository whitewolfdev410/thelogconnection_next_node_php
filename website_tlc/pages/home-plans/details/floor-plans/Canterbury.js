...
const FloorPlanPage = () => {
    ...
    return (
        <>
            <Head>
                <title>{`Canterbury`} Log Home Design by The Log Connection</title>
                <meta property="og:image" content={`${IMG_BANNER_FILE_ROOT}Canterbury.jpg`} />
                <meta property="og:type" content="article" />
                <meta property="og:url" content={`${HOME_PLAN_DETAILS_PATH.FLOOR_PLAN}/Canterbury?scroll=false`} />
                <meta property="og:title" content={`Canterbury Log Home Design by The Log Connection`} />
                <meta property="og:description" content={`Floor plans for Canterbury`} />
            </Head>
            <section>
                <HomePlanBanner
