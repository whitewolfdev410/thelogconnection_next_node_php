...
const FloorPlanPage = () => {
    ...
    return (
        <>
            <Head>
                <title>{`Edgewood`} Log Home Design by The Log Connection</title>
                <meta property="og:image" content={`${IMG_BANNER_FILE_ROOT}Edgewood.jpg`} />
                <meta property="og:type" content="article" />
                <meta property="og:url" content={`${HOME_PLAN_DETAILS_PATH.FLOOR_PLAN}/Edgewood?scroll=false`} />
                <meta property="og:title" content={`Edgewood Log Home Design by The Log Connection`} />
                <meta property="og:description" content={`Floor plans for Edgewood`} />
            </Head>
            <section>
                <HomePlanBanner
