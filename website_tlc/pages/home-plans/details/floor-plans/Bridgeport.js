...
const FloorPlanPage = () => {
    ...
    return (
        <>
            <Head>
                <title>{`Bridgeport`} Log Home Design by The Log Connection</title>
                <meta property="og:image" content={`${IMG_BANNER_FILE_ROOT}Bridgeport.jpg`} />
                <meta property="og:type" content="article" />
                <meta property="og:url" content={`${HOME_PLAN_DETAILS_PATH.FLOOR_PLAN}/Bridgeport?scroll=false`} />
                <meta property="og:title" content={`Bridgeport Log Home Design by The Log Connection`} />
                <meta property="og:description" content={`Floor plans for Bridgeport`} />
            </Head>
            <section>
                <HomePlanBanner
