...
const FloorPlanPage = () => {
    ...
    return (
        <>
            <Head>
                <title>{`Sherman_Oaks`} Log Home Design by The Log Connection</title>
                <meta property="og:image" content={`${IMG_BANNER_FILE_ROOT}Sherman_Oaks.jpg`} />
                <meta property="og:type" content="article" />
                <meta property="og:url" content={`${HOME_PLAN_DETAILS_PATH.FLOOR_PLAN}/Sherman_Oaks?scroll=false`} />
                <meta property="og:title" content={`Sherman_Oaks Log Home Design by The Log Connection`} />
                <meta property="og:description" content={`Floor plans for Sherman_Oaks`} />
            </Head>
            <section>
                <HomePlanBanner
