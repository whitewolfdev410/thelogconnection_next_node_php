...
const FloorPlanPage = () => {
    ...
    return (
        <>
            <Head>
                <title>{`Elk_Haven`} Log Home Design by The Log Connection</title>
                <meta property="og:image" content={`${IMG_BANNER_FILE_ROOT}Elk_Haven.jpg`} />
                <meta property="og:type" content="article" />
                <meta property="og:url" content={`${HOME_PLAN_DETAILS_PATH.FLOOR_PLAN}/Elk_Haven?scroll=false`} />
                <meta property="og:title" content={`Elk_Haven Log Home Design by The Log Connection`} />
                <meta property="og:description" content={`Floor plans for Elk_Haven`} />
            </Head>
            <section>
                <HomePlanBanner
