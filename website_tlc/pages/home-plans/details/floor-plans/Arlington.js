...
const FloorPlanPage = () => {
    ...
    return (
        <>
            <Head>
                <title>{`Arlington`} Log Home Design by The Log Connection</title>
                <meta property="og:image" content={`${IMG_BANNER_FILE_ROOT}Arlington.jpg`} />
                <meta property="og:type" content="article" />
                <meta property="og:url" content={`${HOME_PLAN_DETAILS_PATH.FLOOR_PLAN}/Arlington?scroll=false`} />
                <meta property="og:title" content={`Arlington Log Home Design by The Log Connection`} />
                <meta property="og:description" content={`Floor plans for Arlington`} />
            </Head>
            <section>
                <HomePlanBanner
