...
const FloorPlanPage = () => {
    ...
    return (
        <>
            <Head>
                <title>{`Blue_Ridge`} Log Home Design by The Log Connection</title>
                <meta property="og:image" content={`${IMG_BANNER_FILE_ROOT}Blue_Ridge.jpg`} />
                <meta property="og:type" content="article" />
                <meta property="og:url" content={`${HOME_PLAN_DETAILS_PATH.FLOOR_PLAN}/Blue_Ridge?scroll=false`} />
                <meta property="og:title" content={`Blue_Ridge Log Home Design by The Log Connection`} />
                <meta property="og:description" content={`Floor plans for Blue_Ridge`} />
            </Head>
            <section>
                <HomePlanBanner
