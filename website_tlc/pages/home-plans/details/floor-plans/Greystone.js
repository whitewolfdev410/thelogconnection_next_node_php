...
const FloorPlanPage = () => {
    ...
    return (
        <>
            <Head>
                <title>{`Greystone`} Log Home Design by The Log Connection</title>
                <meta property="og:image" content={`${IMG_BANNER_FILE_ROOT}Greystone.jpg`} />
                <meta property="og:type" content="article" />
                <meta property="og:url" content={`${HOME_PLAN_DETAILS_PATH.FLOOR_PLAN}/Greystone?scroll=false`} />
                <meta property="og:title" content={`Greystone Log Home Design by The Log Connection`} />
                <meta property="og:description" content={`Floor plans for Greystone`} />
            </Head>
            <section>
                <HomePlanBanner
