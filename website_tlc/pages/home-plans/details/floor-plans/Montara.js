...
const FloorPlanPage = () => {
    ...
    return (
        <>
            <Head>
                <title>{`Montara`} Log Home Design by The Log Connection</title>
                <meta property="og:image" content={`${IMG_BANNER_FILE_ROOT}Montara.jpg`} />
                <meta property="og:type" content="article" />
                <meta property="og:url" content={`${HOME_PLAN_DETAILS_PATH.FLOOR_PLAN}/Montara?scroll=false`} />
                <meta property="og:title" content={`Montara Log Home Design by The Log Connection`} />
                <meta property="og:description" content={`Floor plans for Montara`} />
            </Head>
            <section>
                <HomePlanBanner
