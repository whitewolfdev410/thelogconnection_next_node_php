...
const FloorPlanPage = () => {
    ...
    return (
        <>
            <Head>
                <title>{`Newport`} Log Home Design by The Log Connection</title>
                <meta property="og:image" content={`${IMG_BANNER_FILE_ROOT}Newport.jpg`} />
                <meta property="og:type" content="article" />
                <meta property="og:url" content={`${HOME_PLAN_DETAILS_PATH.FLOOR_PLAN}/Newport?scroll=false`} />
                <meta property="og:title" content={`Newport Log Home Design by The Log Connection`} />
                <meta property="og:description" content={`Floor plans for Newport`} />
            </Head>
            <section>
                <HomePlanBanner
