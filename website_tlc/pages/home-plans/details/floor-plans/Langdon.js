...
const FloorPlanPage = () => {
    ...
    return (
        <>
            <Head>
                <title>{`Langdon`} Log Home Design by The Log Connection</title>
                <meta property="og:image" content={`${IMG_BANNER_FILE_ROOT}Langdon.jpg`} />
                <meta property="og:type" content="article" />
                <meta property="og:url" content={`${HOME_PLAN_DETAILS_PATH.FLOOR_PLAN}/Langdon?scroll=false`} />
                <meta property="og:title" content={`Langdon Log Home Design by The Log Connection`} />
                <meta property="og:description" content={`Floor plans for Langdon`} />
            </Head>
            <section>
                <HomePlanBanner
