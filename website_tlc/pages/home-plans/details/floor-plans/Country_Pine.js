...
const FloorPlanPage = () => {
    ...
    return (
        <>
            <Head>
                <title>{`Country_Pine`} Log Home Design by The Log Connection</title>
                <meta property="og:image" content={`${IMG_BANNER_FILE_ROOT}Country_Pine.jpg`} />
                <meta property="og:type" content="article" />
                <meta property="og:url" content={`${HOME_PLAN_DETAILS_PATH.FLOOR_PLAN}/Country_Pine?scroll=false`} />
                <meta property="og:title" content={`Country_Pine Log Home Design by The Log Connection`} />
                <meta property="og:description" content={`Floor plans for Country_Pine`} />
            </Head>
            <section>
                <HomePlanBanner
