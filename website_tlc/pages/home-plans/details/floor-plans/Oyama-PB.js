...
const FloorPlanPage = () => {
    ...
    return (
        <>
            <Head>
                <title>{`Oyama-PB`} Log Home Design by The Log Connection</title>
                <meta property="og:image" content={`${IMG_BANNER_FILE_ROOT}Oyama-PB.jpg`} />
                <meta property="og:type" content="article" />
                <meta property="og:url" content={`${HOME_PLAN_DETAILS_PATH.FLOOR_PLAN}/Oyama-PB?scroll=false`} />
                <meta property="og:title" content={`Oyama-PB Log Home Design by The Log Connection`} />
                <meta property="og:description" content={`Floor plans for Oyama-PB`} />
            </Head>
            <section>
                <HomePlanBanner
