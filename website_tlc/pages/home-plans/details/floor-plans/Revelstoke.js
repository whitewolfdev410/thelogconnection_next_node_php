...
const FloorPlanPage = () => {
    ...
    return (
        <>
            <Head>
                <title>{`Revelstoke`} Log Home Design by The Log Connection</title>
                <meta property="og:image" content={`${IMG_BANNER_FILE_ROOT}Revelstoke.jpg`} />
                <meta property="og:type" content="article" />
                <meta property="og:url" content={`${HOME_PLAN_DETAILS_PATH.FLOOR_PLAN}/Revelstoke?scroll=false`} />
                <meta property="og:title" content={`Revelstoke Log Home Design by The Log Connection`} />
                <meta property="og:description" content={`Floor plans for Revelstoke`} />
            </Head>
            <section>
                <HomePlanBanner
