...
const FloorPlanPage = () => {
    ...
    return (
        <>
            <Head>
                <title>{`Woodridge`} Log Home Design by The Log Connection</title>
                <meta property="og:image" content={`${IMG_BANNER_FILE_ROOT}Woodridge.jpg`} />
                <meta property="og:type" content="article" />
                <meta property="og:url" content={`${HOME_PLAN_DETAILS_PATH.FLOOR_PLAN}/Woodridge?scroll=false`} />
                <meta property="og:title" content={`Woodridge Log Home Design by The Log Connection`} />
                <meta property="og:description" content={`Floor plans for Woodridge`} />
            </Head>
            <section>
                <HomePlanBanner
