...
const FloorPlanPage = () => {
    ...
    return (
        <>
            <Head>
                <title>{`Valhalla`} Log Home Design by The Log Connection</title>
                <meta property="og:image" content={`${IMG_BANNER_FILE_ROOT}Valhalla.jpg`} />
                <meta property="og:type" content="article" />
                <meta property="og:url" content={`${HOME_PLAN_DETAILS_PATH.FLOOR_PLAN}/Valhalla?scroll=false`} />
                <meta property="og:title" content={`Valhalla Log Home Design by The Log Connection`} />
                <meta property="og:description" content={`Floor plans for Valhalla`} />
            </Head>
            <section>
                <HomePlanBanner
