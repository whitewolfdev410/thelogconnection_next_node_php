...
const FloorPlanPage = () => {
    ...
    return (
        <>
            <Head>
                <title>{`Astoria`} Log Home Design by The Log Connection</title>
                <meta property="og:image" content={`${IMG_BANNER_FILE_ROOT}Astoria.jpg`} />
                <meta property="og:type" content="article" />
                <meta property="og:url" content={`${HOME_PLAN_DETAILS_PATH.FLOOR_PLAN}/Astoria?scroll=false`} />
                <meta property="og:title" content={`Astoria Log Home Design by The Log Connection`} />
                <meta property="og:description" content={`Floor plans for Astoria`} />
            </Head>
            <section>
                <HomePlanBanner
