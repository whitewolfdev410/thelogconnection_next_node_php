...
const FloorPlanPage = () => {
    ...
    return (
        <>
            <Head>
                <title>{`Cascade`} Log Home Design by The Log Connection</title>
                <meta property="og:image" content={`${IMG_BANNER_FILE_ROOT}Cascade.jpg`} />
                <meta property="og:type" content="article" />
                <meta property="og:url" content={`${HOME_PLAN_DETAILS_PATH.FLOOR_PLAN}/Cascade?scroll=false`} />
                <meta property="og:title" content={`Cascade Log Home Design by The Log Connection`} />
                <meta property="og:description" content={`Floor plans for Cascade`} />
            </Head>
            <section>
                <HomePlanBanner
