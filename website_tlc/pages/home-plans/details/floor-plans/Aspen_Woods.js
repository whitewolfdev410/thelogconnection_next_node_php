...
const FloorPlanPage = () => {
    ...
    return (
        <>
            <Head>
                <title>{`Aspen_Woods`} Log Home Design by The Log Connection</title>
                <meta property="og:image" content={`${IMG_BANNER_FILE_ROOT}Aspen_Woods.jpg`} />
                <meta property="og:type" content="article" />
                <meta property="og:url" content={`${HOME_PLAN_DETAILS_PATH.FLOOR_PLAN}/Aspen_Woods?scroll=false`} />
                <meta property="og:title" content={`Aspen_Woods Log Home Design by The Log Connection`} />
                <meta property="og:description" content={`Floor plans for Aspen_Woods`} />
            </Head>
            <section>
                <HomePlanBanner
