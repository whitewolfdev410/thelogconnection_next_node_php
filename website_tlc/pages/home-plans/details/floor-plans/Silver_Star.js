...
const FloorPlanPage = () => {
    ...
    return (
        <>
            <Head>
                <title>{`Silver_Star`} Log Home Design by The Log Connection</title>
                <meta property="og:image" content={`${IMG_BANNER_FILE_ROOT}Silver_Star.jpg`} />
                <meta property="og:type" content="article" />
                <meta property="og:url" content={`${HOME_PLAN_DETAILS_PATH.FLOOR_PLAN}/Silver_Star?scroll=false`} />
                <meta property="og:title" content={`Silver_Star Log Home Design by The Log Connection`} />
                <meta property="og:description" content={`Floor plans for Silver_Star`} />
            </Head>
            <section>
                <HomePlanBanner
