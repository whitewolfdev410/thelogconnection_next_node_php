...
const FloorPlanPage = () => {
    ...
    return (
        <>
            <Head>
                <title>{`Creston`} Log Home Design by The Log Connection</title>
                <meta property="og:image" content={`${IMG_BANNER_FILE_ROOT}Creston.jpg`} />
                <meta property="og:type" content="article" />
                <meta property="og:url" content={`${HOME_PLAN_DETAILS_PATH.FLOOR_PLAN}/Creston?scroll=false`} />
                <meta property="og:title" content={`Creston Log Home Design by The Log Connection`} />
                <meta property="og:description" content={`Floor plans for Creston`} />
            </Head>
            <section>
                <HomePlanBanner
