...
const FloorPlanPage = () => {
    ...
    return (
        <>
            <Head>
                <title>{`Modesto`} Log Home Design by The Log Connection</title>
                <meta property="og:image" content={`${IMG_BANNER_FILE_ROOT}Modesto.jpg`} />
                <meta property="og:type" content="article" />
                <meta property="og:url" content={`${HOME_PLAN_DETAILS_PATH.FLOOR_PLAN}/Modesto?scroll=false`} />
                <meta property="og:title" content={`Modesto Log Home Design by The Log Connection`} />
                <meta property="og:description" content={`Floor plans for Modesto`} />
            </Head>
            <section>
                <HomePlanBanner
