...
const FloorPlanPage = () => {
    ...
    return (
        <>
            <Head>
                <title>{`Juniper-PB`} Log Home Design by The Log Connection</title>
                <meta property="og:image" content={`${IMG_BANNER_FILE_ROOT}Juniper-PB.jpg`} />
                <meta property="og:type" content="article" />
                <meta property="og:url" content={`${HOME_PLAN_DETAILS_PATH.FLOOR_PLAN}/Juniper-PB?scroll=false`} />
                <meta property="og:title" content={`Juniper-PB Log Home Design by The Log Connection`} />
                <meta property="og:description" content={`Floor plans for Juniper-PB`} />
            </Head>
            <section>
                <HomePlanBanner
