...
const FloorPlanPage = () => {
    ...
    return (
        <>
            <Head>
                <title>{`Deerfield`} Log Home Design by The Log Connection</title>
                <meta property="og:image" content={`${IMG_BANNER_FILE_ROOT}Deerfield.jpg`} />
                <meta property="og:type" content="article" />
                <meta property="og:url" content={`${HOME_PLAN_DETAILS_PATH.FLOOR_PLAN}/Deerfield?scroll=false`} />
                <meta property="og:title" content={`Deerfield Log Home Design by The Log Connection`} />
                <meta property="og:description" content={`Floor plans for Deerfield`} />
            </Head>
            <section>
                <HomePlanBanner
