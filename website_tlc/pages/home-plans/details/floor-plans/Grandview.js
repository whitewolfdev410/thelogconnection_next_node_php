...
const FloorPlanPage = () => {
    ...
    return (
        <>
            <Head>
                <title>{`Grandview`} Log Home Design by The Log Connection</title>
                <meta property="og:image" content={`${IMG_BANNER_FILE_ROOT}Grandview.jpg`} />
                <meta property="og:type" content="article" />
                <meta property="og:url" content={`${HOME_PLAN_DETAILS_PATH.FLOOR_PLAN}/Grandview?scroll=false`} />
                <meta property="og:title" content={`Grandview Log Home Design by The Log Connection`} />
                <meta property="og:description" content={`Floor plans for Grandview`} />
            </Head>
            <section>
                <HomePlanBanner
