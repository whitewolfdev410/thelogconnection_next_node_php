...
const FloorPlanPage = () => {
    ...
    return (
        <>
            <Head>
                <title>{`Cottonwood`} Log Home Design by The Log Connection</title>
                <meta property="og:image" content={`${IMG_BANNER_FILE_ROOT}Cottonwood.jpg`} />
                <meta property="og:type" content="article" />
                <meta property="og:url" content={`${HOME_PLAN_DETAILS_PATH.FLOOR_PLAN}/Cottonwood?scroll=false`} />
                <meta property="og:title" content={`Cottonwood Log Home Design by The Log Connection`} />
                <meta property="og:description" content={`Floor plans for Cottonwood`} />
            </Head>
            <section>
                <HomePlanBanner
