...
const FloorPlanPage = () => {
    ...
    return (
        <>
            <Head>
                <title>{`Majestic`} Log Home Design by The Log Connection</title>
                <meta property="og:image" content={`${IMG_BANNER_FILE_ROOT}Majestic.jpg`} />
                <meta property="og:type" content="article" />
                <meta property="og:url" content={`${HOME_PLAN_DETAILS_PATH.FLOOR_PLAN}/Majestic?scroll=false`} />
                <meta property="og:title" content={`Majestic Log Home Design by The Log Connection`} />
                <meta property="og:description" content={`Floor plans for Majestic`} />
            </Head>
            <section>
                <HomePlanBanner
