...
const FloorPlanPage = () => {
    ...
    return (
        <>
            <Head>
                <title>{`Monashee`} Log Home Design by The Log Connection</title>
                <meta property="og:image" content={`${IMG_BANNER_FILE_ROOT}Monashee.jpg`} />
                <meta property="og:type" content="article" />
                <meta property="og:url" content={`${HOME_PLAN_DETAILS_PATH.FLOOR_PLAN}/Monashee?scroll=false`} />
                <meta property="og:title" content={`Monashee Log Home Design by The Log Connection`} />
                <meta property="og:description" content={`Floor plans for Monashee`} />
            </Head>
            <section>
                <HomePlanBanner
