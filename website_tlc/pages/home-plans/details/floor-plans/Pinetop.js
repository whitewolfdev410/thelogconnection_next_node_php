...
const FloorPlanPage = () => {
    ...
    return (
        <>
            <Head>
                <title>{`Pinetop`} Log Home Design by The Log Connection</title>
                <meta property="og:image" content={`${IMG_BANNER_FILE_ROOT}Pinetop.jpg`} />
                <meta property="og:type" content="article" />
                <meta property="og:url" content={`${HOME_PLAN_DETAILS_PATH.FLOOR_PLAN}/Pinetop?scroll=false`} />
                <meta property="og:title" content={`Pinetop Log Home Design by The Log Connection`} />
                <meta property="og:description" content={`Floor plans for Pinetop`} />
            </Head>
            <section>
                <HomePlanBanner
