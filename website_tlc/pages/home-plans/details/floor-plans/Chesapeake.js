...
const FloorPlanPage = () => {
    ...
    return (
        <>
            <Head>
                <title>{`Chesapeake`} Log Home Design by The Log Connection</title>
                <meta property="og:image" content={`${IMG_BANNER_FILE_ROOT}Chesapeake.jpg`} />
                <meta property="og:type" content="article" />
                <meta property="og:url" content={`${HOME_PLAN_DETAILS_PATH.FLOOR_PLAN}/Chesapeake?scroll=false`} />
                <meta property="og:title" content={`Chesapeake Log Home Design by The Log Connection`} />
                <meta property="og:description" content={`Floor plans for Chesapeake`} />
            </Head>
            <section>
                <HomePlanBanner
