...
const FloorPlanPage = () => {
    ...
    return (
        <>
            <Head>
                <title>{`Guesthouse`} Log Home Design by The Log Connection</title>
                <meta property="og:image" content={`${IMG_BANNER_FILE_ROOT}Guesthouse.jpg`} />
                <meta property="og:type" content="article" />
                <meta property="og:url" content={`${HOME_PLAN_DETAILS_PATH.FLOOR_PLAN}/Guesthouse?scroll=false`} />
                <meta property="og:title" content={`Guesthouse Log Home Design by The Log Connection`} />
                <meta property="og:description" content={`Floor plans for Guesthouse`} />
            </Head>
            <section>
                <HomePlanBanner
