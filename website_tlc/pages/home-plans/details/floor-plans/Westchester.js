...
const FloorPlanPage = () => {
    ...
    return (
        <>
            <Head>
                <title>{`Westchester`} Log Home Design by The Log Connection</title>
                <meta property="og:image" content={`${IMG_BANNER_FILE_ROOT}Westchester.jpg`} />
                <meta property="og:type" content="article" />
                <meta property="og:url" content={`${HOME_PLAN_DETAILS_PATH.FLOOR_PLAN}/Westchester?scroll=false`} />
                <meta property="og:title" content={`Westchester Log Home Design by The Log Connection`} />
                <meta property="og:description" content={`Floor plans for Westchester`} />
            </Head>
            <section>
                <HomePlanBanner
