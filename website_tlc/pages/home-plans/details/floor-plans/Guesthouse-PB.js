...
const FloorPlanPage = () => {
    ...
    return (
        <>
            <Head>
                <title>{`Guesthouse-PB`} Log Home Design by The Log Connection</title>
                <meta property="og:image" content={`${IMG_BANNER_FILE_ROOT}Guesthouse-PB.jpg`} />
                <meta property="og:type" content="article" />
                <meta property="og:url" content={`${HOME_PLAN_DETAILS_PATH.FLOOR_PLAN}/Guesthouse-PB?scroll=false`} />
                <meta property="og:title" content={`Guesthouse-PB Log Home Design by The Log Connection`} />
                <meta property="og:description" content={`Floor plans for Guesthouse-PB`} />
            </Head>
            <section>
                <HomePlanBanner
