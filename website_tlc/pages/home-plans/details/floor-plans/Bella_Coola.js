...
const FloorPlanPage = () => {
    ...
    return (
        <>
            <Head>
                <title>{`Bella_Coola`} Log Home Design by The Log Connection</title>
                <meta property="og:image" content={`${IMG_BANNER_FILE_ROOT}Bella_Coola.jpg`} />
                <meta property="og:type" content="article" />
                <meta property="og:url" content={`${HOME_PLAN_DETAILS_PATH.FLOOR_PLAN}/Bella_Coola?scroll=false`} />
                <meta property="og:title" content={`Bella_Coola Log Home Design by The Log Connection`} />
                <meta property="og:description" content={`Floor plans for Bella_Coola`} />
            </Head>
            <section>
                <HomePlanBanner
