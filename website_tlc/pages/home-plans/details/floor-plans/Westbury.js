...
const FloorPlanPage = () => {
    ...
    return (
        <>
            <Head>
                <title>{`Westbury`} Log Home Design by The Log Connection</title>
                <meta property="og:image" content={`${IMG_BANNER_FILE_ROOT}Westbury.jpg`} />
                <meta property="og:type" content="article" />
                <meta property="og:url" content={`${HOME_PLAN_DETAILS_PATH.FLOOR_PLAN}/Westbury?scroll=false`} />
                <meta property="og:title" content={`Westbury Log Home Design by The Log Connection`} />
                <meta property="og:description" content={`Floor plans for Westbury`} />
            </Head>
            <section>
                <HomePlanBanner
