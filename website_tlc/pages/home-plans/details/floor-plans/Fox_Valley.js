...
const FloorPlanPage = () => {
    ...
    return (
        <>
            <Head>
                <title>{`Fox_Valley`} Log Home Design by The Log Connection</title>
                <meta property="og:image" content={`${IMG_BANNER_FILE_ROOT}Fox_Valley.jpg`} />
                <meta property="og:type" content="article" />
                <meta property="og:url" content={`${HOME_PLAN_DETAILS_PATH.FLOOR_PLAN}/Fox_Valley?scroll=false`} />
                <meta property="og:title" content={`Fox_Valley Log Home Design by The Log Connection`} />
                <meta property="og:description" content={`Floor plans for Fox_Valley`} />
            </Head>
            <section>
                <HomePlanBanner
