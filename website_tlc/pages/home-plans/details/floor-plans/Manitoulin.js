...
const FloorPlanPage = () => {
    ...
    return (
        <>
            <Head>
                <title>{`Manitoulin`} Log Home Design by The Log Connection</title>
                <meta property="og:image" content={`${IMG_BANNER_FILE_ROOT}Manitoulin.jpg`} />
                <meta property="og:type" content="article" />
                <meta property="og:url" content={`${HOME_PLAN_DETAILS_PATH.FLOOR_PLAN}/Manitoulin?scroll=false`} />
                <meta property="og:title" content={`Manitoulin Log Home Design by The Log Connection`} />
                <meta property="og:description" content={`Floor plans for Manitoulin`} />
            </Head>
            <section>
                <HomePlanBanner
