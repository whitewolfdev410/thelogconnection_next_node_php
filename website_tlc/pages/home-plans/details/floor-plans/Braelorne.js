...
const FloorPlanPage = () => {
    ...
    return (
        <>
            <Head>
                <title>{`Braelorne`} Log Home Design by The Log Connection</title>
                <meta property="og:image" content={`${IMG_BANNER_FILE_ROOT}Braelorne.jpg`} />
                <meta property="og:type" content="article" />
                <meta property="og:url" content={`${HOME_PLAN_DETAILS_PATH.FLOOR_PLAN}/Braelorne?scroll=false`} />
                <meta property="og:title" content={`Braelorne Log Home Design by The Log Connection`} />
                <meta property="og:description" content={`Floor plans for Braelorne`} />
            </Head>
            <section>
                <HomePlanBanner
