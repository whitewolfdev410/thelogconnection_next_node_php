...
const FloorPlanPage = () => {
    ...
    return (
        <>
            <Head>
                <title>{`Bavarian_Dream`} Log Home Design by The Log Connection</title>
                <meta property="og:image" content={`${IMG_BANNER_FILE_ROOT}Bavarian_Dream.jpg`} />
                <meta property="og:type" content="article" />
                <meta property="og:url" content={`${HOME_PLAN_DETAILS_PATH.FLOOR_PLAN}/Bavarian_Dream?scroll=false`} />
                <meta property="og:title" content={`Bavarian_Dream Log Home Design by The Log Connection`} />
                <meta property="og:description" content={`Floor plans for Bavarian_Dream`} />
            </Head>
            <section>
                <HomePlanBanner
