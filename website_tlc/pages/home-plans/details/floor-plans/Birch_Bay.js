...
const FloorPlanPage = () => {
    ...
    return (
        <>
            <Head>
                <title>{`Birch_Bay`} Log Home Design by The Log Connection</title>
                <meta property="og:image" content={`${IMG_BANNER_FILE_ROOT}Birch_Bay.jpg`} />
                <meta property="og:type" content="article" />
                <meta property="og:url" content={`${HOME_PLAN_DETAILS_PATH.FLOOR_PLAN}/Birch_Bay?scroll=false`} />
                <meta property="og:title" content={`Birch_Bay Log Home Design by The Log Connection`} />
                <meta property="og:description" content={`Floor plans for Birch_Bay`} />
            </Head>
            <section>
                <HomePlanBanner
