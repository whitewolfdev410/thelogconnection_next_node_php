...
const FloorPlanPage = () => {
    ...
    return (
        <>
            <Head>
                <title>{`Winston`} Log Home Design by The Log Connection</title>
                <meta property="og:image" content={`${IMG_BANNER_FILE_ROOT}Winston.jpg`} />
                <meta property="og:type" content="article" />
                <meta property="og:url" content={`${HOME_PLAN_DETAILS_PATH.FLOOR_PLAN}/Winston?scroll=false`} />
                <meta property="og:title" content={`Winston Log Home Design by The Log Connection`} />
                <meta property="og:description" content={`Floor plans for Winston`} />
            </Head>
            <section>
                <HomePlanBanner
