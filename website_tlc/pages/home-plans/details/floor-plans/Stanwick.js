...
const FloorPlanPage = () => {
    ...
    return (
        <>
            <Head>
                <title>{`Stanwick`} Log Home Design by The Log Connection</title>
                <meta property="og:image" content={`${IMG_BANNER_FILE_ROOT}Stanwick.jpg`} />
                <meta property="og:type" content="article" />
                <meta property="og:url" content={`${HOME_PLAN_DETAILS_PATH.FLOOR_PLAN}/Stanwick?scroll=false`} />
                <meta property="og:title" content={`Stanwick Log Home Design by The Log Connection`} />
                <meta property="og:description" content={`Floor plans for Stanwick`} />
            </Head>
            <section>
                <HomePlanBanner
