...
const FloorPlanPage = () => {
    ...
    return (
        <>
            <Head>
                <title>{`Alpine`} Log Home Design by The Log Connection</title>
                <meta property="og:image" content={`${IMG_BANNER_FILE_ROOT}Alpine.jpg`} />
                <meta property="og:type" content="article" />
                <meta property="og:url" content={`${HOME_PLAN_DETAILS_PATH.FLOOR_PLAN}/Alpine?scroll=false`} />
                <meta property="og:title" content={`Alpine Log Home Design by The Log Connection`} />
                <meta property="og:description" content={`Floor plans for Alpine`} />
            </Head>
            <section>
                <HomePlanBanner
