...
const FloorPlanPage = () => {
    ...
    return (
        <>
            <Head>
                <title>{`Bonavista`} Log Home Design by The Log Connection</title>
                <meta property="og:image" content={`${IMG_BANNER_FILE_ROOT}Bonavista.jpg`} />
                <meta property="og:type" content="article" />
                <meta property="og:url" content={`${HOME_PLAN_DETAILS_PATH.FLOOR_PLAN}/Bonavista?scroll=false`} />
                <meta property="og:title" content={`Bonavista Log Home Design by The Log Connection`} />
                <meta property="og:description" content={`Floor plans for Bonavista`} />
            </Head>
            <section>
                <HomePlanBanner
