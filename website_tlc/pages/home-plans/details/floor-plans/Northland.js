...
const FloorPlanPage = () => {
    ...
    return (
        <>
            <Head>
                <title>{`Northland`} Log Home Design by The Log Connection</title>
                <meta property="og:image" content={`${IMG_BANNER_FILE_ROOT}Northland.jpg`} />
                <meta property="og:type" content="article" />
                <meta property="og:url" content={`${HOME_PLAN_DETAILS_PATH.FLOOR_PLAN}/Northland?scroll=false`} />
                <meta property="og:title" content={`Northland Log Home Design by The Log Connection`} />
                <meta property="og:description" content={`Floor plans for Northland`} />
            </Head>
            <section>
                <HomePlanBanner
