...
const FloorPlanPage = () => {
    ...
    return (
        <>
            <Head>
                <title>{`Linden`} Log Home Design by The Log Connection</title>
                <meta property="og:image" content={`${IMG_BANNER_FILE_ROOT}Linden.jpg`} />
                <meta property="og:type" content="article" />
                <meta property="og:url" content={`${HOME_PLAN_DETAILS_PATH.FLOOR_PLAN}/Linden?scroll=false`} />
                <meta property="og:title" content={`Linden Log Home Design by The Log Connection`} />
                <meta property="og:description" content={`Floor plans for Linden`} />
            </Head>
            <section>
                <HomePlanBanner
