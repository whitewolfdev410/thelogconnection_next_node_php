...
const FloorPlanPage = () => {
    ...
    return (
        <>
            <Head>
                <title>{`Whistler`} Log Home Design by The Log Connection</title>
                <meta property="og:image" content={`${IMG_BANNER_FILE_ROOT}Whistler.jpg`} />
                <meta property="og:type" content="article" />
                <meta property="og:url" content={`${HOME_PLAN_DETAILS_PATH.FLOOR_PLAN}/Whistler?scroll=false`} />
                <meta property="og:title" content={`Whistler Log Home Design by The Log Connection`} />
                <meta property="og:description" content={`Floor plans for Whistler`} />
            </Head>
            <section>
                <HomePlanBanner
