...
const FloorPlanPage = () => {
    ...
    return (
        <>
            <Head>
                <title>{`Texas_Ranch`} Log Home Design by The Log Connection</title>
                <meta property="og:image" content={`${IMG_BANNER_FILE_ROOT}Texas_Ranch.jpg`} />
                <meta property="og:type" content="article" />
                <meta property="og:url" content={`${HOME_PLAN_DETAILS_PATH.FLOOR_PLAN}/Texas_Ranch?scroll=false`} />
                <meta property="og:title" content={`Texas_Ranch Log Home Design by The Log Connection`} />
                <meta property="og:description" content={`Floor plans for Texas_Ranch`} />
            </Head>
            <section>
                <HomePlanBanner
