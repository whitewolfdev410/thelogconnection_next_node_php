...
const FloorPlanPage = () => {
    ...
    return (
        <>
            <Head>
                <title>{`Montague`} Log Home Design by The Log Connection</title>
                <meta property="og:image" content={`${IMG_BANNER_FILE_ROOT}Montague.jpg`} />
                <meta property="og:type" content="article" />
                <meta property="og:url" content={`${HOME_PLAN_DETAILS_PATH.FLOOR_PLAN}/Montague?scroll=false`} />
                <meta property="og:title" content={`Montague Log Home Design by The Log Connection`} />
                <meta property="og:description" content={`Floor plans for Montague`} />
            </Head>
            <section>
                <HomePlanBanner
