...
const FloorPlanPage = () => {
    ...
    return (
        <>
            <Head>
                <title>{`Treen_Hill`} Log Home Design by The Log Connection</title>
                <meta property="og:image" content={`${IMG_BANNER_FILE_ROOT}Treen_Hill.jpg`} />
                <meta property="og:type" content="article" />
                <meta property="og:url" content={`${HOME_PLAN_DETAILS_PATH.FLOOR_PLAN}/Treen_Hill?scroll=false`} />
                <meta property="og:title" content={`Treen_Hill Log Home Design by The Log Connection`} />
                <meta property="og:description" content={`Floor plans for Treen_Hill`} />
            </Head>
            <section>
                <HomePlanBanner
