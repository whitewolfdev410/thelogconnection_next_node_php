...
const FloorPlanPage = () => {
    ...
    return (
        <>
            <Head>
                <title>Log Home Design by The Log Connection</title>
                <meta property="og:image" content={`${IMG_BASE_URL}/home/_banner/2.jpg`} />
                <meta property="og:type" content="article" />
                <meta property="og:url" content={`${process.env.DOMAIN}/home-plans`} />
                <meta property="og:title" content={`Log Home Design by The Log Connection`} />
