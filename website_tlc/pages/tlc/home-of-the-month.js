...
const HomeOfTheMonthPage = () => {
    ...
    return (
        <>
            <Head>
                <title>Home of the Month by The Log Connection</title>
                <meta property="og:title" content={`Home of the Month by The Log Connection`} />
                <meta property="og:url" content={`${process.env.DOMAIN}/home-of-the-month`} />
                    ...
                    <MDBRow>
                        <MDBCol md="2" lg="2" xl="2" sm="12" className={`${STYLES.left} mt-5`}>
                            {hotm[0]?.quote === 'x' ?
                                (<MDBRow className="my-md-5">
                                    <MDBCol sm="12" md="6" lg="6" className={`${STYLES.label} pt-2`}>
                                        <Link href={`${HOME_PLAN_DETAILS_PATH.PRICE_QUOTE}/${hotm[0]?.planCode}`}>Price Quote </Link>
                                    </MDBCol>
                                    <MDBCol sm="12" md="6" lg="6">
                                        <Link href={`${HOME_PLAN_DETAILS_PATH.PRICE_QUOTE}/${hotm[0]?.planCode}`}>
                            ...
                            {hotm[0]?.pictures === 'x' ?
                                (<MDBRow className="my-md-5">
                                    <MDBCol sm="12" md="6" lg="6" className={`${STYLES.label} pt-2`}>
                                        <Link href={`${HOME_PLAN_DETAILS_PATH.IMAGE_GALLERY}/${hotm[0]?.planCode}`}>Images &amp; Videos</Link>
                                    </MDBCol>
                                    <MDBCol sm="12" md="6" lg="6">
                                        <Link href={`${HOME_PLAN_DETAILS_PATH.IMAGE_GALLERY}/${hotm[0]?.planCode}`}>
                                            <div className={`${STYLES.iconCont}`}>
                        ...
                        <MDBCol md="10" sm="12" lg="10" xl="10">
                            <div className={`${STYLES.mainImgCont} m-5`}>
                                ...
                                <img className="disablecopy" src={`${HP_ROOT}${hotm[0]?.planCode}/hotm.jpg`} />
                            </div>
                        </MDBCol>
                    </MDBRow>
