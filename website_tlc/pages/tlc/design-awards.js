...
const DesignAwardsPage = () => {
  ...
  return (
    <>
      <Head>
        <title>Log Home Design Awards for The Log Connection</title>
        <meta property="og:title" content={`Log Home Design Awards for The Log Connection`} />
        <meta property="og:url" content={`${process.env.DOMAIN}/design-awards`} />
            ...
            {CABINS_AWARDS.map((t, i) => (
              <MDBCol key={i}>
                <div className={TLC_STYLES.thumbnail}>
                  <img className="disablecopy" src={t.imageUrl} />
