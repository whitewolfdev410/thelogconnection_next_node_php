...
export const ConstructionPage = () => {
  ...
  return (
    <>
      <Head>
        <title>Log Home Construction Gallery by The Log Connection</title>
        <meta property="og:title" content={`Log Home Construction Gallery by The Log Connection`} />
        <meta property="og:url" content={`${process.env.DOMAIN}/galleries/construction`} />
