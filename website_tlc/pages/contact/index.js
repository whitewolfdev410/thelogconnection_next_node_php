...
const ContactForm = () => {
    ...
    return (
        <>
            <Head>
                <title>Contact Us at The Log Connection</title>
                ...
                <meta property="og:title" content={`Contact Us at The Log Connection`} />
                <meta property="og:description" content={``} />
            </Head>
            <section className={STYLES.contactPage}>
                <MDBContainer className="pb-5 px-5">
                    <MDBRow className="mb-n4 align-items-start">
                    ...
                    <MDBRow center>
                            ...
                            <form autoComplete="off" onSubmit={handleSubmit}>
                                <MDBRow className="mt-3">
                                    <MDBCol md="7" className="mt-2">
                                        ...
                                        <input type="text" id="firstName" name="firstNm" className={`${STYLES.inputBox}`} onChange={handleInput} />
                                    </MDBCol>
                                    <MDBCol md="5" className="mt-2">
                                        <label className="d-flex mb-0" htmlFor="lastName">LAST NAME</label>
                                        <input type="text" id="lastName" name="lastNm" className={STYLES.inputBox} onChange={handleInput} />
                                    </MDBCol>
                                </MDBRow>
                        ...
                        <MDBCol md="6">
                            <div className={`${STYLES.socMed} mt-4`}>
                                {SOC_MED.map((s, i) => (
                                    <div key={i} className={STYLES.cont}><a href={s.link} target="_blank"><img src={s.imgUrl} alt={s.label} /></a></div>
                                ))}
                            </div>
                            <h3 className="mt-4 text-right">Mailing address:</h3>
                            <h4 className="text-right">69 Nanaimo Ave E #203, Penticton, BC V2A 1M1, Canada</h4>
                        </MDBCol>
                    </MDBRow>
