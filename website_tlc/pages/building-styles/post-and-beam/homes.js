...
const PB_HomesPage = () => {
    ...
    return (
        <>
            <Head>
                <title>Post &amp; Beam Log Home by The Log Connection</title>
                <meta property="og:image" content={`${process.env.DOMAIN}/images/share/PB_Roundlogs_Share.jpg`} />
                <meta property="og:type" content="article" />
                <meta property="og:url" content={`${process.env.DOMAIN}/building-styles/post-and-beam/homes`} />
                <meta property="og:title" content={`Post & Beam Log Home by The Log Connection`} />
                <meta property="og:description" content={`One of many advantages is that a post and beam home does not have the design limitations found with a stacked log package due to settling. Without those rigid design guidelines, the options are nearly endless for architectural expression and award winning design creativity.`} />
            </Head>
                ...
                <MDBContainer >
                    <MDBRow className={PB_STYLES.section1} center>
                        ...
                        <MDBCol md="6" sm="12" xs="12" className={PB_STYLES.mainRight}>
                            <img className="disablecopy" src='/images/building-styles/post-and-beam/traditional/pb_traditional_1.jpg' />
                        </MDBCol>
                    </MDBRow>
                    ...
                    <MDBRow className={PB_STYLES.section2}>
                        <MDBCol md="6" sm="12">
                            <div className={PB_STYLES.card}>
                                <div className={PB_STYLES.imgCont}><img className="disablecopy" src='/images/building-styles/post-and-beam/traditional/pb_traditional_2.jpg' /></div>
                                <p>The Log Connection has over 30 consecutive years experience designing and building hand crafted post and beam log homes. The traditional round log post and beam style (as shown on this page) and our newer more modern <Link href="/building-styles/post-and-beam/four-square/">4Square&#8482; system</Link>  has become very popular in recent years.</p>
                            </div>
                        </MDBCol>
                        <MDBCol md="6" sm="12">
                            <div className={PB_STYLES.card}>
                                <div className={PB_STYLES.imgCont}><img className="disablecopy" src='/images/building-styles/post-and-beam/traditional/pb_traditional_3.jpg' /></div>
