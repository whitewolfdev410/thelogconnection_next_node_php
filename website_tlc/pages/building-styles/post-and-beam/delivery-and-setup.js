...
const PB_DeliveryAndSetupPage = () => {
    return (
        <>
            <Head>
                <title>Set up of the Log Shell for Post &amp; Beam Log Home</title>
                <meta property="og:title" content={`Set up of the Log Shell for Post & Beam Log Home`} />
                <meta property="og:url" content={`${process.env.DOMAIN}/building-styles/post-and-beam/delivery-and-setup`} />
                    ...
                    <MDBRow className={PB_STYLES.section1}>
                        ...
                        <MDBCol md="6" sm="12" className={PB_STYLES.right}>
                            <div className={PB_STYLES.imgCont}>
                                <img className="disablecopy" src='/images/building-styles/post-and-beam/delivery-and-setup/pb_das_1.jpg' />
                            </div>
                    ...
                    <MDBRow className={PB_STYLES.section2}>
                            ...
                            <MDBRow>
                                <MDBCol md="6" lg="5" sm="12">
                                    <div className={PB_STYLES.deliveryImgCont}>
                                        <img className="disablecopy" src='/images/building-styles/post-and-beam/delivery-and-setup/pb_das_2.jpg' />
                                    </div>
                                </MDBCol>
                        ...
                        <MDBCol md="6" sm="12" lg="6">
                            ...
                            <MDBRow>
                                <MDBCol md="6" lg="5" sm="12">
                                    <div className={PB_STYLES.deliveryImgCont}>
                                        <img className="disablecopy" src='/images/building-styles/post-and-beam/delivery-and-setup/pb_das_3.jpg' />
                                    </div>
                                </MDBCol>
                                <MDBCol md="6" lg="7" sm="12">
                                    <div className={PB_STYLES.deliveryDetailsCont}>
