...
const SLW_DeliveryAndSetupPage = () => {
    return (
        <>
            <Head>
                <title>Set up of the Log Shell for Stacked Log Home</title>
                <meta property="og:title" content={`Set up of the Log Shell for Stacked Log Home`} />
                <meta property="og:url" content={`${process.env.DOMAIN}/building-styles/stacked-log-walls/delivery-and-setup`} />
                <meta property="og:image" content={`${process.env.DOMAIN}/images/share/SLW_Delivery.jpg`} />
                    ...
                    <MDBRow className={SLW_STYLES.section1}>
                        ...
                        <MDBCol md="6" sm="12" className={SLW_STYLES.right}>
                            <div className={SLW_STYLES.imgCont}>
                                <img className="disablecopy" src='/images/building-styles/stacked-log-walls/delivery-and-setup/slw_das_1.jpg' />
                            </div>
                    ...
                    <MDBRow className={`${SLW_STYLES.section2} mt-5`} >
                            ...
                            <MDBRow>
                                <MDBCol md="6" lg="5" sm="12">
                                    <div className={SLW_STYLES.deliveryImgCont}>
                                        <img className="disablecopy" src='/images/building-styles/stacked-log-walls/delivery-and-setup/slw_das_2.jpg' />
                                    </div>
                                </MDBCol>
                        ...
                        <MDBCol md="6" sm="12" lg="6">
                            ...
                            <MDBRow>
                                <MDBCol md="6" lg="5" sm="12">
                                    <div className={SLW_STYLES.deliveryImgCont}>
                                        <img className="disablecopy" src='/images/building-styles/stacked-log-walls/delivery-and-setup/slw_das_3.jpg' />
                                    </div>
                                </MDBCol>
                                <MDBCol md="6" lg="7" sm="12">
                                    <div className={SLW_STYLES.deliveryDetailsCont}>
