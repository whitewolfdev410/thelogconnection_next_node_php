...
const SLW_OverscribingPage = () => {
    ...
    return (
        <>
            <Head>
                <title>The Log Home Overscribe Advantage</title>
                <meta property="og:title" content={`The Log Home Overscribe Advantage`} />
                <meta property="og:url" content={`${process.env.DOMAIN}/building-styles/stacked-log-walls/overscribing`} />
                <meta property="og:image" content={`${process.env.DOMAIN}/images/share/SLW_Overscribe_Share.jpg`} />
                <meta property="og:description" content={`What you see today may not be what you see in the future if your builder neglects to employ the complete overscribe technique. Every Log Connection home is built using the Overscribe method to ensure that your home maintains its natural beauty and handcrafted character for years to come.`} />
            ...
            <section id="main_section_overScribe" className={SLW_STYLES.overScribe}>
                    ...
                    <MDBRow>
                        ...
                        <MDBCol md="6" className={SLW_STYLES.right}>
                            <div className={SLW_STYLES.imgCont}>
                                <img className="disablecopy" src='/images/building-styles/stacked-log-walls/overscribe/overscribe.jpg' />
                            </div>
                        </MDBCol>
                    </MDBRow>
                ...
                <MDBContainer >
                    <MDBRow center className={SLW_STYLES.section2}>
                        ...
                        <MDBCol md="6">
                            <div className={SLW_STYLES.imgCont}>
                                <img className="disablecopy" src='/images/building-styles/stacked-log-walls/overscribe/overscribe-before.gif' />
                                <img className="disablecopy" src='/images/building-styles/stacked-log-walls/overscribe/overscribe-after.gif' />
                            </div>
                        </MDBCol>
                        <MDBCol md="3" />
                    </MDBRow>
