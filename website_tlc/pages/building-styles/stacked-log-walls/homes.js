...
const SLW_HomesPage = () => {
    return (
        <>
            <Head>
                <title>Stacked Log Home by The Log Connection</title>
                <meta property="og:title" content={`Stacked Log Home by The Log Connection`} />
                <meta property="og:url" content={`${process.env.DOMAIN}/building-styles/stacked-log-walls/homes`} />
                <meta property="og:image" content={`${process.env.DOMAIN}/images/share/SLW_Share.jpg`} />
                <meta property="og:description" content={`Stacked log homes feature main floor walls which consist entirely of logs, stacked horizontally on top of each other, typically up to the beginning of the roof structure.`} />
                ...
                <MDBContainer>
                    <MDBRow className={SLW_STYLES.section1} center>
                        ...
                        <MDBCol md="6" lg="6" xl="6" className={SLW_STYLES.mainRight}>
                            <img className="disablecopy" src={`${IMG_ROOT}slw_trad_1.jpg`} />
                        </MDBCol>
                    </MDBRow>
