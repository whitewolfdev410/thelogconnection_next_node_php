    ...
    return (
        <>
            <Head>
                ...
                <meta property="og:url" content={`${process.env.DOMAIN}/building-styles/stacked-log-walls/log-species`} />
                <meta property="og:image" content={`${process.env.DOMAIN}/images/share/SLW_LogSpecies_Share.jpg`} />
                ...
                <MDBContainer className={SLW_STYLES.section1} >
                    <MDBRow>
                        <MDBCol md="6" className={SLW_STYLES.leftCont}>
                            <div className={SLW_STYLES.mainImgCont}><img className="disablecopy" src='/images/building-styles/stacked-log-walls/log-species/slw_ls_1.jpg' /></div>
                        </MDBCol>
                    ...
                    <MDBRow className={SLW_STYLES.section2} >
                        <MDBCol md="4" sm="12">
                            <div className={SLW_STYLES.card}>
                                <img className="disablecopy" src='/images/building-styles/stacked-log-walls/log-species/slw_ls_card_douglasFir.jpg' />
                                <h4>Douglas Fir</h4>
                        ...
                        <MDBCol md="4" sm="12">
                            <div className={SLW_STYLES.card}>
                                <img className="disablecopy" src='/images/building-styles/stacked-log-walls/log-species/slw_ls_card_engelmannSpruce.jpg' />
                        ...
                        <MDBCol md="4" sm="12">
                            <div className={SLW_STYLES.card}>
                                <img className="disablecopy" src='/images/building-styles/stacked-log-walls/log-species/slw_ls_card_westernRedCedar.jpg' />
