...
const SLW_DryingAndSettlingPage = () => {
    ...
    return (
        <>
            <Head>
                <title>Drying &amp; Settling of Stack Log Wall in a Log Home</title>
                <meta property="og:title" content={`Drying & Settling of Stack Log Wall in a Log Home`} />
                <meta property="og:url" content={`${process.env.DOMAIN}/building-styles/stacked-log-walls/drying-and-settling`} />
                <meta property="og:image" content={`${process.env.DOMAIN}/images/share/The_log_Connection_Logo_Square.jpg`} />
                <meta property="og:description" content={`It is important to note that this shrinkage is only measurable across the wood grain and not along its length. Wood is a beautiful and versatile natural material with many advantages: it is renewable, it has great strength, it is easily shaped, and it has good thermal insulating properties.`} />
            ...
            <section className={SLW_STYLES.dryAndSet}>
                ...
                <MDBContainer className={SLW_STYLES.section2} >
                    <MDBRow className={SLW_STYLES.subSection}>
                        ...
                        <MDBCol md="5" >
                            <div className={SLW_STYLES.imgCont}><img className="disablecopy" src='/images/building-styles/stacked-log-walls/drying-and-settling/stair-landing-space.jpg' /></div>
                    ...
                    <MDBRow className={SLW_STYLES.subSection}>
                        ...
                        <MDBCol md="5">
                            <div className={SLW_STYLES.imgCont}><img className="disablecopy" src='/images/building-styles/stacked-log-walls/drying-and-settling/wall-frame-lagbolted.jpg' /></div>
                    ...
                    <MDBRow className={SLW_STYLES.subSection}>
                        ...
                        <MDBCol md="5">
                            <div className={SLW_STYLES.imgCont}><img className="disablecopy" src='/images/building-styles/stacked-log-walls/drying-and-settling/screwjack-atwindow.jpg' /></div>
                    ...
                    <MDBRow className={SLW_STYLES.subSection}>
                        ...
                        <MDBCol md="5">
                            <div className={SLW_STYLES.imgCont}><img className="disablecopy" src='/images/building-styles/stacked-log-walls/drying-and-settling/trims-windows-finished.jpg' /></div>
                            <p className={SLW_STYLES.caption}>Finished slip trims neatly conceal settling space</p>
                        </MDBCol>
                    </MDBRow>
                    <MDBRow className={SLW_STYLES.subSection}>
                        <MDBCol md="6">
                            <div className={SLW_STYLES.imgCont}><img className="disablecopy" src='/images/building-styles/stacked-log-walls/drying-and-settling/window-bucks.jpg' /></div>
                            <p className={SLW_STYLES.caption}>Steel angle installed</p>
                        </MDBCol>
                        <MDBCol md="6">
                            <div className={SLW_STYLES.imgCont}><img className="disablecopy" src='/images/building-styles/stacked-log-walls/drying-and-settling/window-spline.jpg' /></div>
