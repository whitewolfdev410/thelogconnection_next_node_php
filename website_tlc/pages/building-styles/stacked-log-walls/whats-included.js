...
const SLW_WhatsIncludedPage = () => {
    ...
    return (
        <>
            <Head>
                <title>What's Included in Stacked Log Home Package</title>
                <meta property="og:title" content={`What's Included in Stacked Log Home Package`} />
                <meta property="og:url" content={`${process.env.DOMAIN}/building-styles/stacked-log-walls/whats-included`} />
                <meta property="og:image" content={`${process.env.DOMAIN}/images/share/SLW_WhatsIncluded.jpg`} />
                ...
                <MDBContainer >
                    <MDBRow className={STYLES.section1} center>
                        ...
                        <MDBCol md="6" className={STYLES.mainRight}>
                            <img className="disablecopy" src='/images/building-styles/stacked-log-walls/whats-included/slw_wi_1.jpg' />
                        </MDBCol>
                    </MDBRow>
                </MDBContainer>

                <WiComponent type={`SL`} />
                <NextPageButton pageUrl={SLW_URL_PATH.SP} pageName={SLW_TITLE.SP} />
            </section>
        </>
    )
}
