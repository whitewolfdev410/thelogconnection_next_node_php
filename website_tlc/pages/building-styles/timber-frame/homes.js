    ...
    return (
        <>
            <Head>
                ...
                <meta property="og:url" content={`${process.env.DOMAIN}/building-styles/timber-frame/homes`} />
                <meta property="og:image" content={`${process.env.DOMAIN}/images/share/Timber_Share.jpg`} />
                <meta property="og:description" content={`A squared timber frame features square cut timber posts and beams, typically featuring detailed knee braces and traditional joinery.`} />
                ...
                <MDBContainer >
                    <MDBRow className={TF_STYLES.section1} center>
                        ...
                        <MDBCol md="6" className={TF_STYLES.mainRight}>
                            <img className="disablecopy" src='/images/building-styles/timber-frame/homes/tf_home_1.jpg' />
                        </MDBCol>
                    </MDBRow>
