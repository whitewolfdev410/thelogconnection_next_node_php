...
const WHATS_INCLUDED = [
    ...
    },
    {
        ...
        description: (<div>Includes our award winning favorite floor plans and exterior views. Select one of the designs from the book for the quickest delivery of your deram home or take advantage of our in-house design team and modify any plan in this book to suit your personal style. If you can dream it we can design it.
            <br />
            <br />We encourage you to give us a call to discuss your log home project. With over 32 years in the log home industry our experienced staff can answer any questions you may have and explain the unique features we offer that distinguish The Log Connection home from the others.
            <br />
            <br />
...
const PlanBookPage = () => {
    ...
    */
    ...
    return (
        <>
            <Head>
                <title>Log Home Plan Book by The Log Connection</title>
                <meta property="og:title" content={`Log Home Plan Book by The Log Connection`} />
                <meta property="og:url" content={`${process.env.DOMAIN}/plan-book`} />
                        ...
                        <MDBCol md="7" sm="12" className="py-2">
                            <MDBRow className={`${STYLES.descCont}`}>
                                ...
                                <MDBCol md="7" className="pr-0 mt-1">
                                    <img className="disablecopy" src={`${IMG_ROOT}plan_book.jpg`} />
                                </MDBCol>
                            </MDBRow>
                            <MDBRow className={`${STYLES.descCont}`}>
                                <MDBCol md="12">
