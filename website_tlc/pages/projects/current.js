...
const CurrentProjectsPage = () => {
  return (
    <>
      <Head>
        <title>Current Projects by The Log Connection</title>
        <meta property="og:title" content={`Current Projects by The Log Connection`} />
        <meta property="og:url" content={`${process.env.DOMAIN}/projects/current`} />
