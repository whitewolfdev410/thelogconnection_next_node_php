...
export const ReadMoreSection = () => {
  ...
  return (
    <section className={`${STYLES.readMoreSection} my-5`} >
      <div className="home-page-section"> 
        <MDBRow center>
          <MDBCol md="7" sm="12" lg="6">
            <div className={STYLES.imgCont}>
              <img className="disablecopy" src={`${IMG_FILE_ROOT}why-choose.jpg`} />
            </div>
          </MDBCol>
