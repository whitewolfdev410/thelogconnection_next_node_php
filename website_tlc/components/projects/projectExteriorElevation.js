...
const ProjectExteriorElevation = ({ projectCode }) => {
    ...
    */
    ...
    return (
        <>
            <Head>
                <title>{projectCode} Log Home Project by the Log Connection</title>
                <meta property="og:image" content={`${process.env.IMG_BASE_URL}/projects/${projectCode}/thumbnail.jpg`} />
                <meta property="og:type" content="article" />
                <meta property="og:url" content={`${PROJECTS_DETAILS_PATH.ELEVATION}/${projectCode}`} />
                <meta property="og:title" content={`${projectCode} Log Home Project by the Log Connection`} />
                <meta property="og:description" content={`Exterior elevations for ${projectCode}`} />
            </Head>
...
export default ProjectExteriorElevation;
